    ...
    <ul class="pagination justify-content-center my-4">
        ...
        @foreach ($elements as $element)
            ...
            @if (is_string($element))
                <li class="page-item page-item-ellipses disabled"><a class="page-link" href="javascript:">{{ $element }}</a></li>
            @endif
            ...
            @if (is_array($element))
                @foreach ($element as $page => $url)
                    @if ($page == $paginator->currentPage())
                        <li class="page-item page-item-active"><a class="page-link" href="javascript:">{{ $page }}</a></li>
                    @else
