        ...
        <div class="card card-custom mt-5 mx-auto">
            <div class="card-body">
                ...
                <div class="text-center">
                    <h1 class="mt-3">{{ $company->name }} {!!verified_badge($company)!!}</h1>
                                ...
                                <a href="{{ route('address.show', $address) }}" class="link-unstyled">
                                    <div class="address scale-on-hover-2">
                                        ...
                                        <p>
                                            ...
                                            <span class="oi oi-briefcase mx-3"></span>{{ $address->jobListings()->count() }} {{ str_plural('listing', $address->jobListings()->count()) }}
                                        </p>
                                    </div>
                                </a>
                                <hr>
