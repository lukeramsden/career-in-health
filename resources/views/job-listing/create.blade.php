                ...
                {{--<div class="card-columns smaller-card-columns">--}}
                        ...
                        {{--<div class="card-body">--}}
                            {{--<div class="form-group">--}}
                                ...
                                {{--<textarea v-model="model.description"--}}
                                          ...
                                          {{--rows="25"--}}
                                          {{--maxlength="3000"--}}
                                          {{--:required="!model.savingForLater"></textarea>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                    {{----}}
                    {{--<div class="card card-custom">--}}
                        {{--<div class="card-body">--}}
                            ...
                            {{--</select2>--}}
                            {{--@endverbatim--}}
                            {{--<p class="text-muted mb-0 mt-2">This will be the address that you want--}}
                                {{--to find staff--}}
                    ...
                    {{--<div class="card card-custom">--}}
                        {{--<div class="card-body">--}}
                            {{--<select2 v-model="model.job_role"--}}
                                     {{--name="job_role"--}}
                                     {{--:required="!model.savingForLater">--}}
                                {{--<option :value="null">-</option>--}}
                            ...
                            {{--<div class="card-body">--}}
                                {{--<div class="form-group">--}}
                                    {{--<div class="custom-control custom-checkbox">--}}
                                        {{--<input type="checkbox"--}}
                                               {{--class="custom-control-input"--}}
                                               {{--id="inputSaveForLater"--}}
                                               {{--name="savingForLater"--}}
                                               {{--v-model="model.savingForLater">--}}
                                        {{--<label class="custom-control-label" for="inputSaveForLater">Save--}}
                                            {{--For--}}
                                            {{--Later?</label>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                    ...
                    {{--@verbatim--}}
                        ...
                        {{--<div class="card card-custom-material card-custom-material-hover card-custom-no-top-bar">--}}
                            {{--<div class="btn-group btn-group-full btn-group-vertical">--}}
                                ...
                                {{--@endverbatim--}}
                                {{--@if($edit)--}}
                                    {{--<a href="{{ route('job-listing.show', $jobListing) }}"--}}
                ...
                {{--} )--}}
                    ...
                    {{--{--}}
                        ...
                        {{--_.forIn(--}}
                            ...
                            {{--( errors,--}}
                              {{--field ) => errors.forEach( ( error ) => toastr.error( error, changeCase.titleCase( field ) ) ),--}}
                        {{--);--}}
                    {{--} );--}}
                {{----}}
