    ...
    <div class="card-body">
      <div v-if="loaded" class="row align-content-center">
        <div class="col-10 col-lg-9 col-xl-11">
          <h4 class="d-inline-block mb-3">Work Experience</h4>
        </div>
                  ...
                  <div class="row">
                    <div class="col-12 mb-3 col-xl-6">
                      ...
                      <input
                        ...
                        class="form-control"
                        maxlength="150"
                        aria-describedby="input_job_title_help_block"
                        required>

                      <small
                        id="input_job_title_help_block"
                        class="form-text text-muted">
                        e.g. Manager, Senior Nurse, Midwife.
                      </small>
                    </div>
                    <div class="col-12 mb-3 col-xl-6">
                      ...
                      <input
                        ...
                        class="form-control"
                        maxlength="150"
                        aria-describedby="input_company_name_help_block"
                        required>

                      <small
                        id="input_company_name_help_block"
                        class="form-text text-muted">
                        Name of the company.
                      </small>
                    </div>
