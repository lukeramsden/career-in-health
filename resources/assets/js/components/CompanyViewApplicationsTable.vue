                    ...
                    <div class="table-responsive mt-4">
                        <table class="table w-100">
                            ...
                            <template v-for="result in results">
                                <tr v-bind:key="result.id">
                                    <td class="text-one-line">{{result.job_listing.title}}</td>
                                    <td class="text-one-line">{{result.employee.full_name}}</td>
                                    <td class="text-one-line" v-if="result.custom_cover_letter">
                                        {{result.custom_cover_letter}}
                                    </td>
                                    <td class="text-one-line" v-else><span class="text-muted font-italic">No cover letter</span>
                                    </td>
